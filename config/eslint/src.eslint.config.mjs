...
export default defineConfig([
    ...
    { files: ['**/*.html'], rules: { 'padding-line-between-statements': 'off' } },
    {
        files: ['**/*.ts'],
        rules: {
            '@angular-eslint/component-selector': ['error', { prefix: 'amb', style: 'kebab-case', type: 'element' }],
            '@angular-eslint/directive-selector': ['error', { prefix: 'amb', style: 'camelCase', type: 'attribute' }],
