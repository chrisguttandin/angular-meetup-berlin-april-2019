        ...
        'csp-production': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: () => {
                        const html = fs.readFileSync('build/angular-meetup-berlin-april-2019/index.html', 'utf-8'); // eslint-disable-line node/no-sync
        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: (_, filename, extension) => grunt.file.expand({ cwd: 'build/angular-meetup-berlin-april-2019', ext: extension }, `assets/${ filename }.*`)[0]
                }, {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: (match, filename, moduleAttribute) => {
                        ...
                        return `<script${ moduleAttribute }>${ fs.readFileSync(`build/angular-meetup-berlin-april-2019/${ filename }`) }</script>`; // eslint-disable-line node/no-sync
                    }
                } ]
            }
        },
