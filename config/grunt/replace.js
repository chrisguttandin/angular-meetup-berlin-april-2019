        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: () => grunt.file.expand({ cwd: 'build/angular-meetup-berlin-april-2019' }, 'assets/*.apple-touch-icon.png')[0]
                }, {
                    match: /assets\/favicon\.ico/g,
                    replacement: () => grunt.file.expand({ cwd: 'build/angular-meetup-berlin-april-2019' }, 'assets/*.favicon.ico')[0]
                }, {
                    ...
                    match: /"\/angular-meetup-berlin-april-2019\/index\.html":\s"[a-z0-9]+"/g,
                    replacement: () => {
                        return `"/angular-meetup-berlin-april-2019/index.html": "${ computeHashOfFile('build/angular-meetup-berlin-april-2019/index.html', 'sha1', 'hex') }"`;
                    }
                } ]
            }
        },
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: (match, filename) => {
                        return `<script type="text/javascript">${ fs.readFileSync(`build/angular-meetup-berlin-april-2019/${ filename }`) }</script>`;
                    }
                } ]
            }
        },
