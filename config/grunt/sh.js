...
module.exports = (grunt) => {
    ...
    return {
        'analyze': {
            cmd:
                'npx ng build --prod --source-map --stats-json && webpack-bundle-analyzer build/angular-meetup-berlin-april-2019/stats.json'
        },
        'build': {
            cmd: 'npx ng build --base-href /angular-meetup-berlin-april-2019/ --prod --subresource-integrity'
        },
        'continuous': {
            cmd: 'npx ng test'
        },
        ...
        'lint-src': {
            cmd: `htmlhint --rules ${convertConfig(documentConfig)} 'src/**/index.html' && \
                ...
                npx ng lint angular-meetup-berlin-april-2019 --type-check`
        },
        'lint-test': {
        ...
        'smoke': {
            cmd: env.CI
                ? "IS_SMOKE_TEST=true npx ng e2e --dev-server-target '' && hint --telemetry=off https://chrisguttandin.github.io/angular-meetup-berlin-april-2019"
                : "webdriver-manager update && IS_SMOKE_TEST=true npx ng e2e --dev-server-target '' --no-webdriver-update && hint --telemetry=off https://chrisguttandin.github.io/angular-meetup-berlin-april-2019"
        },
        'test': {
            cmd: 'npx ng test --watch false'
        },
        'verify': {
            cmd: `bundle-buddy build/angular-meetup-berlin-april-2019/*.js.map && \
