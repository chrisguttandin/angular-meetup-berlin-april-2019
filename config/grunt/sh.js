...
module.exports = (grunt) => {
    ...
    return {
        ...
        'lint-src': {
            cmd: `htmlhint --rules ${ convertConfig(documentConfig) } 'src/**/index.html' && htmlhint --rules ${ convertConfig(templateConfig) } 'src/app/**/*.component.html' && ng lint angular-meetup-berlin-april-2019 --type-check`
        },
        'lint-test': {
        ...
        'prerender': {
            cmd: 'ng run angular-meetup-berlin-april-2019:server:production && angular-prerender'
        },
        'preview': {
        ...
        'smoke': {
            cmd: (env.TRAVIS) ?
                "IS_SMOKE_TEST=true ng e2e --dev-server-target '' && hint --telemetry=off https://chrisguttandin.github.io/angular-meetup-berlin-april-2019" :
                "webdriver-manager update && IS_SMOKE_TEST=true ng e2e --dev-server-target '' --no-webdriver-update && hint --telemetry=off https://chrisguttandin.github.io/angular-meetup-berlin-april-2019"
        },
        'test': {
