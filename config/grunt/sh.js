...
module.exports = {
    ...
    lint: {
        cmd: 'ng lint angular-meetup-berlin-april-2019 --type-check && ng lint angular-meetup-berlin-april-2019-e2e --type-check && ng lint angular-meetup-berlin-april-2019-unit --type-check'
    },
    monitor: {
        cmd: 'ng serve --aot'
    },
